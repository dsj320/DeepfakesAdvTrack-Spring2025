...
class GenConViTVAE(nn.Module):
    def __init__(self):
        ...
        self.embedder = create_model('swin_tiny_patch4_window7_224', pretrained=False)
        self.convnext_backbone = create_model('convnext_tiny', pretrained=False, num_classes=1000, drop_path_rate=0, head_init_scale=1.0)
